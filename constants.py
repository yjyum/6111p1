...
stopWord = ["a", "a's", "able", "about", "above", "according", "accordingly",
 			...
 			"hasn't", "have", "haven't", "having", "he", "he's", "hello", "help", "hence", 
 			...
 			"howbeit", "however", "i", "i'd", "i'll", "i'm", "i've", "ie", "if", "ignored",
 			 ...
 			 "likely", "little", "look", "looking", "looks", "ltd", "m", "mainly", "many", 
 			 ...
 			 "often", "oh", "ok", "okay", "old", "on", "once", "one", "ones", "only", "onto", 
 			 "or", "other", "others", "otherwise", "ought", "our", "ours", "ourselves", "out", 
 			 "outside", "over", "overall", "own", "p", "particular", "particularly", "per", 
 			 ...
 			 "went", "were", "weren't", "what", "what's", "whatever", "when", "whence", "whenever", 
 			 ...
 			 "whose", "why", "will", "willing", "wish", "with", "within", "without", "won't", "wonder", 
 			 "would", "would", "wouldn't", "x", "y", "yes", "yet", "you", "you'd", "you'll", "you're", 
